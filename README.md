...
Similar to [Eco](https://store.steampowered.com/app/382310/Eco/) game, where players take on the role of a mayor of a small town. Players need to manage resources, build infrastructure, and make decisions that affect the town's growth and development. Town lives even if the player is offline, similarly to [Utopia](https://utopia-game.com/).
